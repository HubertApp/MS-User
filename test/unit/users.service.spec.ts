...
describe('UsersService', () => {
  ...
  test('should return user when user is found', () => {
    const newUser = { id: 1, email: 'test@test.fr', username: 'testuser', age: 30, handicape: false };
  ...
  test('should create a new user', () => {
    const newUser = { id: 2, email: 'test@test.fr', username: 'testuser2', age: 25, handicape: true };
